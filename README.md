...
\begin{align}
\hat{\theta}_{MAP} = {\arg\max}_{\theta}P(\theta|D) &= \mathop{\arg\max}_{\theta}\frac{P(D|\theta)P(\theta)}{P(D)}\\
...
# w_old.shape = (n, 1), <type 'numpy.ndarray'>
# w_new.shape = (n, 1), <type 'numpy.ndarray'>
# lamb.shape = (n, n), <type 'numpy.ndarray'>, take the regularization parameter lambda's name as lamb, 
